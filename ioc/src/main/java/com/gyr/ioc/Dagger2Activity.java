...
//        Log.e("dagger2","swordsman:"+swordsman.fighting());
        Swordsman swordsman=swordsmanLazy.get();
        Log.e("dagger2","lazy1:"+swordsman.fighting());
        Log.e("dagger2","lazy2:"+swordsman.fighting());
    }
    @OnClick(R.id.tv1)
    public void tt1(){
        Toast.makeText(this,"11",Toast.LENGTH_SHORT).show();
        Intent intent=new Intent(this,Dagger3Activity.class);
